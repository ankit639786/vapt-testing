...
export const homeObjThree = {
  ...
  bulletPoints:["Deep-level understanding of how hackers operate & cause threats.","Perform in-depth security threat and vulnerability analysis.","Complete pre- and post-care of the enterprise's network for effective risk mitigation.","Experienced support of professional testing agents.","Proactive monitoring alert and support system."],
  buttonLabel: '',
  imgStart: 'start',
